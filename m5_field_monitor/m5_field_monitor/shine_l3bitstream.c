...
#include "shine_l3bitstream.h" /* the public interface */
#include "shine_bitstream.h"
#include "shine_huffman.h"
#include "shine_l3loop.h"
#include "shine_l3mdct.h"
#include "shine_layer3.h"
#include "shine_tables.h"
